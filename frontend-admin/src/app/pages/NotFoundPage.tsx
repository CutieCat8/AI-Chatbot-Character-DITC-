  ...
  return (
    <div className="nf-page">
      ...
      <div className="nf-copy">
        <svg aria-labelledby="nf-svgtitle1" className="nf-not-found" viewBox="80 60 480 180">
          <title id="nf-svgtitle1">404 Page not found</title>
        ...
        <div className="nf-search-row">
          ...
          <svg className="nf-search-icon" width="26" height="25.8">
            <path
              opacity=".4"
              fill="#68A1D6"
...
.nf-all-stars {
  animation: nf-blinkblink 7s linear infinite;
}
@keyframes nf-blinkblink {
  50% { opacity: 0.1; }
}
.nf-copy {
  color: #fff;

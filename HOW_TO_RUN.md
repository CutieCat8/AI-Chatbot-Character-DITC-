...
ยังไม่มีบัญชีแอดมินในระบบ — เปิด **http://localhost:5173/register** แล้วสมัครเองได้เลย
(สมัครเสร็จล็อกอินให้อัตโนมัติ)

ถ้าลืมรหัสผ่าน รีเซ็ตผ่าน backend ได้ (รันซ้ำด้วยอีเมลเดิม = รีเซ็ตรหัสผ่านให้):
